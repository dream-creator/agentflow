...
> Extends TypeScript and common patterns with React specific content. For hook-specific rules see hooks.md.
...
For React-specific deep dives see react-patterns skill. For cross-framework frontend concerns see frontend-patterns skill. For accessibility see accessibility skill.
