...
> Extends TypeScript and common security rules with React specific content.
...
- Use `security-reviewer` subagent for comprehensive security audits across the codebase
- Use `typescript-reviewer` or `code-reviewer` subagent for React-specific patterns and the above rules in active code review
