...
NEXT_PUBLIC_PAYMONGO_PUBLISHABLE_KEY=pk_test_...
...
Locally, you need to forward PayMongo events to your dev server:
...
`PAYMONGO_WEBHOOK_SECRET` in `.env.local`. Do **not** use the
