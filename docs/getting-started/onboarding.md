...
See [TESTING.md](../guides/testing.md) for the full breakdown of
...
5. Return errors using the envelope from
  [API-REFERENCE.md](../guides/api-reference.md#error-envelope).
6. Add unit tests in `tests/unit/api/`.

### Add a new page

1. Decide: server component (default) or client component?
  See [ARCHITECTURE.md](../guides/architecture.md#server-vs-client).
...
[supabase/migrations/](../guides/database.md#schema). The user
...
- [ARCHITECTURE.md](../guides/architecture.md) — the 5-minute
  overview.
- [AUTHENTICATION.md](../guides/authentication.md) — if you're touching
  the login/signup/middleware flow.
- [DATABASE.md](../guides/database.md) — if you're writing a
  migration or changing a table.
- [DEPLOYMENT.md](../guides/deployment.md) — before merging your first
  PR.
