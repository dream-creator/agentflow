...
- Name: lead-crud.spec.ts >> Lead CRUD >> should display pipeline stages in lead form
- Location: tests/e2e/lead-crud.spec.ts:51:7
...
Locator: locator('select[name="stage"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('select[name="stage"]')
