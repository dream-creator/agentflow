...
- Name: csv-import.spec.ts >> CSV Import >> should have column mapping section
- Location: tests/e2e/csv-import.spec.ts:41:7
...
Locator: locator('text=Map Columns')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Map Columns')
