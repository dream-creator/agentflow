...
- Name: pipeline.spec.ts >> Pipeline >> should show empty state for each stage
- Location: tests/e2e/pipeline.spec.ts:33:7
...
Locator: locator('text=No leads in this stage')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=No leads in this stage')
