...
- Name: follow-ups.spec.ts >> Follow-ups >> should have mark complete functionality placeholder
- Location: tests/e2e/follow-ups.spec.ts:40:7
...
Locator: locator('text=No follow-ups scheduled')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=No follow-ups scheduled')
