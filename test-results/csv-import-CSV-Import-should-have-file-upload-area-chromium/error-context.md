...
- Name: csv-import.spec.ts >> CSV Import >> should have file upload area
- Location: tests/e2e/csv-import.spec.ts:14:7
...
Locator: locator('text=Upload CSV')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Upload CSV')
