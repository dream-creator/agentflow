...
- Name: csv-import.spec.ts >> CSV Import >> should show drag and drop zone
- Location: tests/e2e/csv-import.spec.ts:19:7
...
Locator: locator('text=Drag & drop')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Drag & drop')
