...
- Name: follow-ups.spec.ts >> Follow-ups >> should show overdue section
- Location: tests/e2e/follow-ups.spec.ts:19:7
...
Call log:
  ...
  - waiting for locator('text=Overdue')
