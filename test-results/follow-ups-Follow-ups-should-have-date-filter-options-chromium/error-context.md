...
- Name: follow-ups.spec.ts >> Follow-ups >> should have date filter options
- Location: tests/e2e/follow-ups.spec.ts:29:7
...
Call log:
  ...
  - waiting for locator('text=Today')
