...
- Name: lead-crud.spec.ts >> Lead CRUD >> should navigate to add lead page
- Location: tests/e2e/lead-crud.spec.ts:18:7
...
Call log:
  ...
  - waiting for locator('text=Add Lead')
