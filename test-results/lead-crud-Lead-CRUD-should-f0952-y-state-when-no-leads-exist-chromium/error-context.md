...
- Name: lead-crud.spec.ts >> Lead CRUD >> should show empty state when no leads exist
- Location: tests/e2e/lead-crud.spec.ts:13:7
...
Locator: locator('text=No leads yet')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=No leads yet')
