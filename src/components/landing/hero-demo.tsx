  ...
  return (
    <>
      ...
      <button
        ...
        className="group relative w-full max-w-4xl mx-auto mt-16 cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 rounded-xl"
        aria-label="Open pipeline demo video"
      >
        <div className="relative overflow-hidden rounded-xl bg-surface-50/80 backdrop-blur-sm border border-surface-200 shadow-2xl transition-all duration-300 group-hover:shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] group-hover:border-surface-300">
          <ReducedMotionVideo
            autoPlay
            loop
            muted
